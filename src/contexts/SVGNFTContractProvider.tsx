...
export interface SVGNFTContext {
  SVGNFTContract?: SVGNFT;
  lastError: string;
}

export const Context = createContext<SVGNFTContext>({ SVGNFTContract: null, lastError:'' });
...
export const SVGNFTContractProvider: React.FC = ({ children }) => {
  ...
  return <Context.Provider value={{ SVGNFTContract: SVGNFTContract, lastError: '' }}>{children}</Context.Provider>;
};
