...
const Decrypt: React.FC<any> = (props) => {
  ...
  const handleEncryptedChange = useCallback((event) => {
        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="form-group">
              ...
              <input type="string" className="form-control" id="encrypt" onChange={handleEncryptedChange}/>
            </div>
            <button type="button" className="btn btn-primary" onClick={handleDecrypt}>Decrypt</button>
            <div style={myText}>
